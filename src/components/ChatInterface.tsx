...
const presetQuestions: PresetQuestion[] = [
  {
    id: 1,
    question: "Rusya-Ukrayna savaşı hakkında en son dezanformasyon örnekleri nelerdir?",
    category: 'general'
  },
  {
    id: 2,
    question: "Türkiye'de son dönemde yayılan ekonomi ile ilgili yanlış bilgiler nelerdir?",
    category: 'general'
  },
  {
    id: 3,
    question: "Sosyal medyada sağlık konusunda en çok yayılan yanıltıcı bilgiler nelerdir?",
    category: 'technical'
  },
  {
    id: 4,
    question: "Deprem sonrası ortaya çıkan dezanformasyon örnekleri nelerdir?",
    category: 'general'
  },
  {
    id: 5,
    question: "Seçim dönemlerinde yaygınlaşan dezenformasyon teknikleri nelerdir?",
    category: 'gameplay'
  },
  {
    id: 6,
    question: "İklim değişikliği konusunda yaygın olan yanlış bilgiler nelerdir?",
    category: 'technical'
  }
];
